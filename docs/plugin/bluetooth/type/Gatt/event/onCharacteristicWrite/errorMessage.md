...
[String](https://docs.coronalabs.com/api/type/String] description of an error when [event.isError.html)(/plugin/bluetooth/type/Gatt/event/onCharacteristicWrite/isError.md) is `true`, `nil` otherwise.